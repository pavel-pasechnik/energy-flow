import{getRequest as u}from"./api-energy-flow-ba3f6c65.js";import"./vendor-5ed05576.js";function f(e){const s=document.getElementById("exerciseModal"),t=document.getElementById("modalBackdrop");s.classList.add("is-visible"),t.classList.add("is-visible"),u(`/exercises/${e}`).then(i=>{i&&i.gifUrl?g(i):console.error("Invalid data or missing gifUrl")}).catch(i=>{console.error("Error fetching exercise data",i)})}function c(){const e=document.getElementById("exerciseModal"),s=document.getElementById("modalBackdrop");e.classList.remove("is-visible"),s.classList.remove("is-visible")}function g(e){const s=document.getElementById("exerciseModal"),t=document.getElementById("modalBackdrop"),i=document.getElementById("exerciseDetails");i.innerHTML="";const r=document.createElement("div");r.innerHTML=`
    ...
    </div>`,i.appendChild(r),s.classList.add("is-visible");const o=document.getElementById("favoriteButton");d(e._id)&&v(o),o.addEventListener("click",()=>{d(e._id)?(y(e._id),b(o)):(h(e),v(o))}),t.addEventListener("click",a=>{a.stopPropagation(),c()}),document.getElementById("closeButton").addEventListener("click",()=>{c()}),document.addEventListener("keydown",a=>{a.key==="Escape"&&c()})}function m(e){return isNaN(e)?"N/A":Math.round(e).toFixed(1)}function p(e){const s=Math.round(e),t=5-s,i=`<svg class="star" width="18" height="18" >
...
//# sourceMappingURL=modal-dd9c76eb.js.map
