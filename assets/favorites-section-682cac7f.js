import{getRequest as o}from"./api-energy-flow-3175d380.js";import"./vendor-cae18210.js";const n=document.querySelector(".favorites-list-item"),c=JSON.parse(localStorage.getItem("favorites"));async function v(){for(const t of c){let e=await o(`/exercises/${t}`).then(s=>s).catch(s=>console.log(s));n.insertAdjacentHTML("beforeend",l(e))}}function l(t){const{bodyPart:e,burnedCalories:s,target:i,time:a,equipment:r}=t;return`<li class="favorits-item">
...
//# sourceMappingURL=favorites-section-682cac7f.js.map
