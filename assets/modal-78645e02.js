import{getRequest as v}from"./api-energy-flow-3175d380.js";import"./vendor-cae18210.js";document.addEventListener("click",e=>{if(e.target.classList.contains("exercises-gallery-btn-start")){const s=e.target.dataset.action;u(s)}});function u(e){v(`/exercises/${e}`).then(s=>{f(s)})}function f(e){const s=document.getElementById("exerciseModal"),t=document.getElementById("exerciseDetails");t.innerHTML="";const o=document.createElement("div");o.innerHTML=`
    ...
    </div>`,t.appendChild(o),s.classList.add("is-visible");const n=document.getElementById("favoriteButton");c(e._id)&&l(n),n.addEventListener("click",()=>{c(e._id)?(b(e._id),h(n)):(m(e._id),l(n))});const r=document.getElementById("exerciseModal");r.addEventListener("click",i=>{(i.target===r||i.target.closest("#closeButton"))&&d()})}function p(e){return isNaN(e)?"N/A":Math.round(e).toFixed(1)}function g(e){const s=Math.round(e),t=5-s,o=`<svg class="star">
    <use href="./img/sprite.svg#colorstar"></use>
</svg>`,n=`
  <svg class="star">
    <use href="./img/sprite.svg#star"></use>
  </svg>
`;let r="";for(let i=0;i<s;i++)r+=o;for(let i=0;i<t;i++)r+=n;return r}function c(e){return a().includes(e)}function a(){return JSON.parse(localStorage.getItem("favorites"))||[]}function m(e){const s=a();s.push(e),localStorage.setItem("favorites",JSON.stringify(s))}function b(e){const t=a().filter(o=>o!==e);localStorage.setItem("favorites",JSON.stringify(t))}function l(e){const s=e.querySelector("span");s.textContent="Remove from",e.querySelector("use").setAttribute("href","./img/sprite.svg#heart")}function h(e){const s=e.querySelector("span");s.textContent="Add to Favorites",e.querySelector("use").setAttribute("href","./img/sprite.svg#heart")}function d(){console.log("Close button clicked");const e=document.getElementById("exerciseModal");e&&e.classList.remove("is-visible")}document.addEventListener("keydown",e=>{e.key==="Escape"&&d()});
//# sourceMappingURL=modal-78645e02.js.map
