...
</a>`,"");if(u.innerHTML=T,i>1){const n=E(r,i);l.innerHTML=n,l.removeEventListener("click",t=>{t.target.tagName==="BUTTON"&&(e.page=parseInt(t.target.textContent),callback(e),e.page=1)})}else l.innerHTML=""}).catch(s=>{console.log(s)})};const c=document.querySelector(".subspecies"),h=document.querySelector(".exercises-nav-panel"),u=document.querySelector(".exercises-gallery"),$=document.querySelector(".exercises-nav-input"),k=document.querySelector(".exercises-nav-input-block"),B=document.querySelector(".input-search-icon"),l=document.querySelector(".pagination"),v=document.querySelector(".exercises-container"),w=document.querySelector(".exercises-current-ex"),S=document.querySelector(".without-exercises");let U=1,d="Muscles",o,C=window.innerWidth,g=0,p=0,m="";C<=375?(g=8,p=8):C<=768?(g=12,p=8):(g=12,p=9);const b={filter:d,page:U,limit:g},a={page:U,limit:p};f(b),h.addEventListener("click",e=>{if(e.target.tagName==="BUTTON")Array.from(e.currentTarget.children).map(s=>{s.textContent!==e.target.textContent?s.classList.remove("exercises-button-isactive"):e.target.classList.add("exercises-button-isactive")}),w.textContent="",d=e.target.textContent.trim(),b.filter=d,delete a[o],v.scrollIntoView({behavior:"smooth"}),f(b),L(b,f),c.classList.remove("is-hidden"),u.classList.add("is-hidden"),k.classList.add("is-hidden");else return}),c.addEventListener("click",e=>{e.preventDefault(),e.target.tagName==="BUTTON"&&(m=e.target.dataset.value,o=d.toLowerCase(),o==="body parts"&&(o="bodypart"),w.textContent=m.charAt(0).toUpperCase()+m.slice(1),a[o]=m,c.classList.add("is-hidden"),u.classList.remove("is-hidden"),k.classList.remove("is-hidden"),v.scrollIntoView({behavior:"smooth"}),x(a),L(a,x))}),B.addEventListener("click",e=>{a.keyword=$.value.trim(),x(a),L(a,x),delete a.keyword}),N()}
//# sourceMappingURL=exercises-c6697995.js.map
