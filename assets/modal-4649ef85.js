import{getRequest as v}from"./api-energy-flow-08c61571.js";import"./vendor-e6025c9a.js";document.addEventListener("click",e=>{if(e.target.classList.contains("exercises-gallery-btn-start")){const t=e.target.dataset.action;m(t)}});function m(e){v(`/exercises/${e}`).then(t=>{f(t)})}function f(e){const t=document.getElementById("exerciseModal"),i=document.getElementById("exerciseDetails");i.innerHTML="";const o=document.createElement("div");o.innerHTML=`
  ...
  <div class="star-divider-container">
    ...
    </div>`,i.appendChild(o),t.classList.add("is-visible");const n=document.getElementById("favoriteButton");c(e._id)&&l(n),n.addEventListener("click",()=>{c(e._id)?(b(e._id),x(n)):(p(e._id),l(n))});const a=document.getElementById("exerciseModal");a.addEventListener("click",s=>{(s.target===a||s.target.closest("#closeButton"))&&d()})}function g(e){return isNaN(e)?"N/A":Math.round(e).toFixed(1)}function u(e){const t=Math.round(e),i=5-t,o='<img src="./img/colorstar.svg" alt="Filled Star" class="star">',n='<img src="./img/star.svg" alt="Empty Star" class="star">';let a="";for(let s=0;s<t;s++)a+=o;for(let s=0;s<i;s++)a+=n;return a}function c(e){return r().includes(e)}function r(){return JSON.parse(localStorage.getItem("favorites"))||[]}function p(e){const t=r();t.push(e),localStorage.setItem("favorites",JSON.stringify(t))}function b(e){const i=r().filter(o=>o!==e);localStorage.setItem("favorites",JSON.stringify(i))}function l(e){e.innerHTML='<span>Remove from</span> <img src="./img/heart.svg" alt="Favorite Icon">'}function x(e){e.innerHTML='<span>Add to Favorites</span> <img src="./img/heart.svg" alt="Favorite Icon">'}function d(){console.log("Close button clicked");const e=document.getElementById("exerciseModal");e&&e.classList.remove("is-visible")}document.addEventListener("keydown",e=>{e.key==="Escape"&&d()});
//# sourceMappingURL=modal-4649ef85.js.map
